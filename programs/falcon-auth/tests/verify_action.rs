...
fn signed_verify_ix_for_cluster(
    fixture: &Fixture,
    cluster: u8,
    nonce: u64,
    expires_slot: u64,
...
#[test]
fn verify_action_rejects_unregistered_cluster() {
    let fixture = make_fixture(0);
    let ix = signed_verify_ix_for_cluster(&fixture, 1, 0, 100, [7u8; 32], [9u8; 32]);
    let result = fixture.mollusk.process_instruction(
        &ix,
        &[
            (fixture.authority, authority_account()),
